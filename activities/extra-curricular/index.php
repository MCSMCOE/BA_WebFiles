				...
				<div class="bnr-inr bg-pt" style="background-image:url(/images/banner/bnr1.jpg);">
					<div class="container">
						<div class="bnr-inr-entry text-center">
							<h1 class="text-capitalize"><span>Extra Curricular</span></h1>
							<!-- Breadcrumb row -->
				...
				<ul id="masonry" class=" gallery-listing gallery-grid-4 gallery mfp-gallery text-center">
					...
					<li class="<?php echo $rows_mastercategory['d_filter'] ?> card-container col-lg-4 col-md-6 col-sm-6 ">
						<div class="box gallery-box">
							<div class="media img-overlay1 img-effect">
								<a href="javascript:void(0);">
<img src=""  alt=""> </a>
								<div class="overlay-bx">
									<div class="overlay-icon">
	<a target="blank" href="<?php echo $rows_mastercategory['link'] ?>"> 
		<?php echo $rows_mastercategory['cdesc'] ?><br>
 <?php
                                                    if (!empty($rows_mastercategory['link'])) {
                                                    ?>
	<font style="color: red;">View More</font>
 <?php
                                                    }
                                                    ?>
</a>
							...
							<div class="dez-info p-a30 bg-white">
								<h5 class="dez-title m-t0"><a target="blank" style="text-transform: capitalize;" href="<?php echo $rows_mastercategory['link'] ?>"><?php echo $rows_mastercategory['c_name'] ?></a></h5>
