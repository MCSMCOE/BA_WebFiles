                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="heading-line-bottom">
                                <h4 class="heading-title mt-0"><a href="cpandimp.php">1.1.1	CURRICULUM PLANNING AND IMPLEMENTATION</h4>
								<h4 class="heading-title mt-0"><a href="tpandqp.php">1.1.3 TEACHERS PARTICIPATION IN BOS , QP SETTINGS AND EVALUATION PROCESS</h4>
								<h4 class="heading-title mt-0"><a href="scd.php">2.3.3 SECOND CRITERION DOCUMENTS</h4>
								</div>
								</div>
							<div class="row">
						   <!--<div class="row">
