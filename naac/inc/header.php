        ...
        <div class="container">
			...
			<li>
                            <a class='blink-bg' href="https://kascsathy.ac.in/admissions/application.php"
                               target="_blank">Online Application</a>
                        </li>
                        <li>
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSevjOh_xV1WpPFcXo-ucaDrwsNBkKXF548ZrwDgD6arh2OBKA/viewform?embedded=true"
                               target="_blank">Admission Enquiry</a>
                        </li>
          ...
          function display_children($parent, $head)
          {
            ...
            while ($row = mysqli_fetch_array($result)) {
              if ($row['Count'] > 0) {
                ...
                echo "<li><a  target='" . $row['target'] . "' href='https://kascsathy.ac.in" . $row['link'] . "'>" . $row['title'] . "</a></li>";
              }
            }
          }
